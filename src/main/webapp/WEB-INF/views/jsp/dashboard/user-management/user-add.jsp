                ...
                <div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 778px;">
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-sm-12">
                            ...
                            <p class="m-b-none"><i class="fa fa-info-circle"></i>Fill out the fields and click on 'Save' button to add new user to the system. 'Administration' have a limited access to the system back-end. They can only view Reservations menu.</p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    <form action="/TicketsO/dashboard/users/create" method="post" id="frmCreateUser" class="form-horizontal" autocomplete="off" novalidate="novalidate">
                                    ...
                                    <span class="hidden-xs">Generate</span>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 col-md-7 col-sm-offset-2">
                                                ...
                                                <a class="btn btn-white btn-lg pull-right" href="/TicketsO/dashboard/users/show">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
