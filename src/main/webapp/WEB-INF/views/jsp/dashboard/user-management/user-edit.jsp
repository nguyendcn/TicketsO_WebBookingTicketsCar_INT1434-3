<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <!DOCTYPE html>
    <!-- saved from url=(0094)http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&action=pjActionUpdate&id=1 -->
    ...
    <body class=" pace-done" data-gr-c-s-loaded="true">
        ...
        <div id="wrapper">
            <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li class="">
                            <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><i class="fa fa-bus"></i> <span class="nav-label">Bus Schedule</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                ...
                                <li>
                                    <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><span class="nav-label">Settings</span><span class="fa arrow"></span></a>
                        ...
                        <li data-menu="pages-and-content">
                            <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><i class="fa fa-book"></i> <span class="nav-label">Pages &amp; Content</span> <span class="fa arrow"></span></a>
                        ...
                        <li data-menu="apps">
                            <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><i class="fa fa fa-desktop"></i> <span class="nav-label">Apps</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                        ...
                        <li data-menu="seo">
                            <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><i class="fa fa-sitemap"></i> <span class="nav-label">SEO</span> <span class="fa arrow"></span></a>
                        ...
                        <li class="active" data-menu="website-settings">
                            <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#"><i class="fa fa-cogs"></i> <span class="nav-label">Website Settings</span> <span class="fa arrow"></span></a>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                ...
                                <li>
                                    <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#">Domain &amp; Email<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level collapse">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 927px;">
                    ...
                    <div class="bar-col bar-col-2of3">
                        <div class="row">
                            ...
                            <div class="bar-col bar-col-1of2 text-right">
                                <div class="bar-top-section">
                                    <a class="bar-top-anchor" href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#" data-toggle="modal" data-target="#contactMsgModal" title="Contact Support">Contact Us</a>
                                </div>
                                <div class="bar-top-section">
                                    <a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1#" class="bar-top-anchor right-sidebar-toggle-main">Help Center</a>
                                </div>
                                <div class="bar-top-section">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><strong>Update User</strong></li>
                                </ol>
                            </div>
                        </div>
                        <p class="m-b-none"><i class="fa fa-info-circle"></i>Review and update User's data. 'Regular Users' have limited access to the back-end system. They can only view the "Reservations" menu.</p>
                    </div>
                </div>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form action="/TicketsO/dashboard/users/updateUser" method="post" id="frmUpdateUser" class="form-horizontal" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-2 control-label" for="password">New Password</label>
                                        <div class="col-xs-8 col-sm-4 col-md-5">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                <input type="text" name="password" id="password" class="form-control" maxlength="100">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-md-7">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="phone" id="phone" class="form-control" value="" maxlength="255">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                ...
                <script type="text/javascript">
                    ...
                    myLabel.sp_ok_title = "Success!";
                    myLabel.sp_err_title = "Failure!";
        ...
        <div class="modal fade" id="contactMsgModal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="contactMsgModalLabel">
            <div class="modal-dialog">
                <form action="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1" method="post" accept-charset="utf-8" id="contactMsgForm" novalidate="novalidate">
