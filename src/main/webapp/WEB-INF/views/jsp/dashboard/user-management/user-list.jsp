<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <!DOCTYPE html>
    <!-- saved from url=(0088)http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&action=pjActionIndex -->
                                            ...
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <tr data-id="id_1">
                                                        ...
                                                        <td class="pj-table-cell-editable"><span class="pj-table-cell-label">nguyen</span><input type="text" data-name="name" class="form-control pj-selector-editable" value="nguyen" style="display: none;"></td>
                                                        <td class="pj-table-cell-editable"><span class="pj-table-cell-label"><a href="mailto:superntseal@gmail.com">superntseal@gmail.com</a></span><input type="text" data-name="email" class="form-control pj-selector-editable" value="superntseal@gmail.com"
                                                                style="display: none;"></td>
                                                        <td><span class="pj-table-cell-label">19/09/2019</span></td>
                                                        <td><span class="pj-table-cell-label">21/09/2019</span></td>
                                                        <td><span class="pj-table-cell-label"><span class="label">Super User</span></span>
                                                        </td>
                                                        <td class="pj-table-cell-editable"><span class="pj-table-cell-label"><div role="button" tabindex="0" aria-disabled="false" class="btn btn-success btn-xs no-margins"><i class="fa fa-check"></i> Active</div></span><input type="hidden"
                                                                data-name="status" class="pj-selector-editable" value="F"></td>
                                                        <td>
                                                            <div class="m-t-xs text-right"><a href="http://trials.vevs.website/nguyenne/index.php?controller=pjCmsUsers&amp;action=pjActionUpdate&amp;id=1" class="btn btn-primary btn-outline btn-sm m-l-xs pj-table-icon-edit"><i class="fa fa-pencil"></i></a></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="row table-responsive-actions">
                                            <div class="col-lg-5 col-md-7 col-sm-7">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-5">
                                                        <div class="input-group"><span class="input-group-btn"><button type="button" class="btn btn-white pj-paginator-list-prev" disabled=""><span class="hidden-sm">« Prev</span><i class="fa fa-step-backward visible-sm-inline-block"></i></button>
                                                            </span><input type="text" name="page" value="1" class="form-control pj-selector-goto"><span class="input-group-btn"><button type="button" class="btn btn-white pj-paginator-list-next" disabled=""><span class="hidden-sm">Next »</span>
                                            ...
                                            <div class="col-lg-7 col-md-5 col-sm-5">
                                                <div class="form-inline show-total mobile-text-right">
                                                    ...
                                                    <div class="form-group m-l-xs"><label>of <strong>1</strong> total</label></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
