        ...
        <%@ taglib uri="http://www.springframework.org/tags" prefix="s" %>
            ...
            <body data-spy="scroll" data-offset="70">
                    ...
                    <span class="navbar-toggler-icon"></span>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="#home"><s:message code="index.home" /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#features"><s:message code="index.features" /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#about-us"><s:message code="index.bustt" /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#contact"><s:message code="index.contact" /></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${pageContext.request.contextPath}/TicketInfo"><s:message code="index.tickets" /></a>
                                </li>
                                <li class="nav-item">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false"><s:message code="index.lang" /></button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-lang="vi" href="#">VietNam</a>
                                            <a class="dropdown-item" data-lang="en" href="#">English</a>
                                        </div>
                                            ...
                                            <div class="col-md-6 pl0 pr0">
                                                <ul class="routes-list">
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-khach-tu-sai-gon-di-mui-ne-binh-thuan" data-param="129t27071.html" id="dp1568964760376"><button type="button"
                                                            class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6  pl0 pr0">
                                                <ul class="routes-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-limousine-tu-ha-noi-di-sa-pa-lao-cai" data-param="124t24241.html" id="dp1568964760382"><button type="button"
                                                            class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6 pl0 pr0">
                                                <ul class="routes-list">
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-limousine-tu-ha-noi-di-vinh-nghe-an" data-param="124t24701.html" id="dp1568964760386"><button type="button"
                                                            class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6  pl0 pr0">
                                                <ul class="routes-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="price fl">80.000 ₫/vé</span>
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-khach-tu-da-nang-di-hoi-an-quang-nam" data-param="115t25221.html" id="dp1568964760393"><button type="button"
                                                            class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6  pl0 pr0">
                                                <ul class="routes-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-limousine-tu-nha-trang-khanh-hoa-di-da-lat-lam-dong" data-param="2359t23991.html" id="dp1568964760404">
                                                        <button type="button" class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6 pl0 pr0">
                                                <ul class="routes-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-khach-tu-nha-trang-khanh-hoa-di-qui-nhon-binh-dinh" data-param="2359t2681.html" id="dp1568964760410">
                                                        <button type="button" class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                                            ...
                                            <div class="col-md-6  pl0 pr0">
                                                <ul class="routes-list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <input class="input-txt selectDate hasDatepicker" type="hidden" data-url="/vi-VN/ve-xe-khach-tu-can-tho-di-da-lat-lam-dong" data-param="113t23991.html" id="dp1568964760415"><button type="button"
                                                            class="ui-datepicker-trigger">Chọn ngày</button>
                                                    </li>
                ...
                <script>
                    ...
                    $('.input-calendar').change(function(event) {
                        var target = event.target;
                        var parent = target.parentElement;

                        console.log(parent.getElementsByTagName('button')[0].click());
                    });

                    $("a[data-lang]").click(function() {
                        var lang = $(this).attr("data-lang");

                        $.get("booking/changelang/?language=" + lang, function() {
                            location.reload();
                            //alert(lang);
                        });
                    });
